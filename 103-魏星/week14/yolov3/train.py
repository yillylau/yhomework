...
from model.YoloClassify import YoloClassify
from model.YOLOLoss import YOLOLoss, get_lr_scheduler, set_optimizer_lr, weights_init
from utils.util import get_classes, get_anchors, show_config
...
1、训练前检查格式是否满足要求，该库要求数据集格式为VOC格式，需要准备好的内容有输入图片和标签
...
if __name__ == "__main__":
    ...
    # ---------------------------------------------------------------------#
    classes_path = 'D:\\ProgramData\\project-data\\cv\\14-lesson14\\dataset\\voc_classes.txt'
    # ---------------------------------------------------------------------#
    #   anchors_path    代表先验框对应的txt文件，一般不修改。
    #   anchors_mask    用于帮助代码找到对应的先验框，一般不修改。
    # ---------------------------------------------------------------------#
    anchors_path = 'D:\\ProgramData\\project-data\\cv\\14-lesson14\\dataset\\yolo_anchors.txt'
    ...
    # ------------------------------------------------------------------#
    save_dir = 'D:\\ProgramData\\project-data\\cv\\14-lesson14\\logs'
    # ------------------------------------------------------------------#
    ...
    #   获得图片路径和标签
    # ----------------------------------------------------#
    train_annotation_path = 'D:\\ProgramData\\project-data\\cv\\14-lesson14\\dataset\\2007_train.txt'
    val_annotation_path = 'D:\\ProgramData\\project-data\\cv\\14-lesson14\\dataset\\2007_val.txt'
    ...
    #   创建yolo模型
    # ------------------------------------------------------#
    model = YoloClassify(num_classes)
    # if pretrained:
    #     weights_init(model)
    # if model_path != '':
    #     if local_rank == 0:
