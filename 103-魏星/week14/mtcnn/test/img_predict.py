...
from mtcnn.utils.utils import generate_bbox, py_nms, convert_to_square
from mtcnn.utils.utils import pad, calibrate_box, processed_image

parser = argparse.ArgumentParser()
parser.add_argument('--model_path', type=str, default='D:\\ProgramData\\project-data\\cv\\14-lesson14\\mtcnn\\weights', help='PNet、RNet、ONet三个模型文件存在的文件夹路径')
parser.add_argument('--image_path', type=str, default='D:\\ProgramData\\project-data\\cv\\14-lesson14\\mtcnn\\dataset\\test.jpg', help='需要预测图像的路径')
