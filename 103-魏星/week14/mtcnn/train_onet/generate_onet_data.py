...
# @Time : 2023/8/17 19:22
# @Author : weixing
# @FileName : generate_onet_data
# @Project : cv
...
from mtcnn.utils.data_format_converter import convert_data
from mtcnn.utils.utils import py_nms, combine_data_list, crop_landmark_image, delete_old_img, pad, processed_image
from mtcnn.utils.utils import save_hard_example, generate_bbox, read_annotation, convert_to_square, calibrate_box
from mtcnn.utils.utils import get_landmark_from_lfw_neg, get_landmark_from_celeba
...
if __name__ == '__main__':
    data_path = 'D:\\ProgramData\\project-data\\cv\\14-lesson14\\mtcnn\\dataset\\'
    base_dir = 'D:\\ProgramData\\project-data\\cv\\14-lesson14\\mtcnn\\dataset\\WIDER_train\\'
    filename = 'D:\\ProgramData\\project-data\\cv\\14-lesson14\\mtcnn\\dataset\\wider_face_train.txt'
    min_face_size = 20
    scale_factor = 0.79
    p_thresh = 0.6
    r_thresh = 0.7
