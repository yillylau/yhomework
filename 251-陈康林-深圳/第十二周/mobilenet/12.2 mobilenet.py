...
from keras.layers import DepthwiseConv2D,Conv2D,Input,Dense,Activation,GlobalAveragePooling2D,Dropout,Reshape,BatchNormalization
...
def _depthwise_conv_block(inputs,pointwise_conv_filters,
                          depth_mutiplier=1,strides=(1,1),block_id=1):
    x = DepthwiseConv2D((3,3),
                        padding='same',
                        depth_multiplier=depth_mutiplier,
                        strides=strides,
                        use_bias=False,
...
def MobileNet(input_shape=[224,224,3],
    ...
    x = Dropout(dropout,name='droput')(x)
