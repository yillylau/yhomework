...
if __name__ == '__main__':
    ...
    model.fit_generator(
        generator=generate_arrays_from_file(lines=lines[:num_train], batch_size=batch_size),
        steps_per_epoch=max(1, num_train // batch_size),
        validation_data=generate_arrays_from_file(lines=lines[num_train:], batch_size=batch_size),
